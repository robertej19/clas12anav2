        ...
        for var3_ind in range(1,len(var3_bins)):
            ...
            for var2_ind in range(1,len(var2_bins)):
                ...
                for var1_ind in range(1,len(var1_bins)):
                    ...
                    counts_sim = dataframe_sim.query(dfq)["counts"]
                    counts_gen = dataframe_lund.query(dfq)["counts"]
                    counts_real = dataframe_real.query(dfq)["counts"]

                    #Put in logic for when dataframe is not empty
                    .values[0]
                    .values[0]
                    .values[0]
